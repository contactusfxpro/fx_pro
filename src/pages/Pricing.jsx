  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-4">
        <p className="font-bold text-4xl text-gray-700 dark:text-[#fafafa]">
          Coming Soon ...
        </p>
        <p className="text-gray-700 dark:text-gray-300 mt-4 max-w-lg mx-auto">
          Our pricing plans unlock advanced market tools, helping you track
          currency movements and make better-informed decisions.
        </p>
      </div>
